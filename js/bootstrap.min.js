...
* plugins: bootstrap-transition.js, bootstrap-dropdown.js, bootstrap-scrollspy.js, bootstrap-tooltip.js, bootstrap-collapse.js, bootstrap-carousel.js
...
$(function(){
	...
	$('.carousel').carousel({pause: "hover",interval: 5000});

	var header_height = $('header').height() -18;

	$('header a, #to_events').on('click', function(event) {
		...
		$('html, body').animate({scrollTop: target_top - header_height}, 500);
	});
